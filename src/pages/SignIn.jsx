...
const SignIn  = () => {
  ...
  return (
   ...
   <div className="flex h-screen
    items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-primary">
  ...
  <strong class="font-bold">You are logging In!</strong>
  ...
  <div class="flex-none w-21 h-5">
   <Link to="/forgot" className='underline'><text className='font-bold text-secondary'>Forget password?
   </text>
   </Link>
  </div>
            ...
            <div>
              ...
              disabled={loading }
                ...
                className="group relative flex w-full justify-center rounded-md border
                 border-transparent bg-secondary py-2 px-4 text-sm font-medium 
                 text-white hover:bg-dimYellow
                "
              >
          ...
          <div className="flex items-center justify-between">
              ...
              <p>Don't have an account? </p>
                ...
                <Link to="/signup"><text className='font-bold text-secondary'>Register Here</text></Link>
                </label>
              </div>
