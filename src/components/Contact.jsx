...
<section class="bg-secondary px-6 py-6" id="contact">
   <div class="container h-full">
      <div class="flex flex-wrap lg:justify-between">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0">
            <h1 className="md:text-5xl text-2xl font-poppins md:leading-normal leading-10 text-white
 font-bold">
        Get in touch with us
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-white font-poppins text-xl mb-1 ">Our Location</h4>
                     <p class="text-base  text-white font-poppins ">
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-xl mb-1 text-white font-poppins">Phone Number</h4>
                     <p class="text-base text-body-color text-white font-poppins">(+62)81 414 257 9980</p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] text-white font-poppins w-full">
                  <div
                     class="
                     max-w-[60px]
                     sm:max-w-[70px]
         ...
         <div class="w-full lg:w-1/2 xl:w-5/12 p-6">
            <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
            <form class="" action="" method="">
            <div class="relative">
              <input id="type" name="email" type="text" class="peer h-10 w-full
               border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none
                focus:border-secondary" placeholder="john@doe.com" />
            ...
            <div class="relative mt-5">
              <input id="email" name="username" type="text" class="peer h-10 w-full
               border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none
                focus:border-secondary" placeholder="john@doe.com" />
              <label for="username" class="absolute left-0 -top-3.5
               text-gray-600 text-sm transition-all peer-placeholder-shown:text-base
                peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5
                 peer-focus:text-gray-600 peer-focus:text-sm">Email</label>
            ...
            <div class="mt-5 relative">
              <input id="text" type="text" name="description"
               class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900
                placeholder-transparent focus:outline-none focus:border-secondary" placeholder="Password" />
              <label for="description" class="absolute left-0 -top-3.5 
              text-gray-600 text-sm transition-all peer-placeholder-shown:text-base
               peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5
                peer-focus:text-gray-600 peer-focus:text-sm">Description</label>
            </div>
         <input type="sumbit" value="Send" 
            class="mt-10 px-4 py-2 rounded-xl bg-secondary hover:bg-dimYellow text-white 
